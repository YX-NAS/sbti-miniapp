...
// ==================== NORMAL_TYPES (pattern-based matching) ====================
export interface NormalTypeEntry { code: string; pattern: string; }
export const NORMAL_TYPES: NormalTypeEntry[] = [
  {
    "code": "CTRL",
...
// ==================== TYPE_LIBRARY ====================
export interface PersonalityType { code: string; cn: string; intro: string; desc: string; dimensions?: Record<string, number>; }
...
export const DRUNK_TRIGGER_QUESTION_ID: string = "drink_gate_q2";