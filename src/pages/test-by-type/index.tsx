        ...
        <View className="result-card">
          ...
          <View className="recommend-strip">
            ...
            {recommendCards.map(item => (
              <View
                key={item.id}
                className="recommend-strip-item"
                onClick={() => {
                  trackEvent('topic_test_recommend_click', { type, entryId: item.id })
                  Taro.navigateTo({ url: item.path })
                }}
              >
                <View className="recommend-strip-left">
                  <Text className="recommend-strip-emoji">{item.emoji}</Text>
                  <View className="recommend-strip-copy">
                    <Text className="recommend-strip-name">{item.title}</Text>
                    <Text className="recommend-strip-desc">{item.desc}</Text>
                  </View>
                </View>
                <Text className="recommend-strip-tag" style={{ color: item.color }}>{item.tag}</Text>
              </View>
            ))}
          </View>
