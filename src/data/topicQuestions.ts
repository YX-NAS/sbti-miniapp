export type TopicTestType = 'char' | 'love' | 'fun' | 'study' | 'cat' | 'ocean' | 'tendency'
...
export const TOPIC_RESULT_META: Record<TopicTestType, Record<TopicResultKey, TopicResultMeta>> = {
  ...
  ocean: {
    A: {
      title: '海豚型',
      desc: '你像海豚一样擅长协作与连接，进入新环境时能快速和人建立轻松互动。你通常是关系里的破冰者，也很会用积极反馈带动团队状态。',
      emoji: '🐬',
      shareTitle: '我是会带气氛的海豚型',
    },
    B: {
      title: '章鱼型',
      desc: '你像章鱼一样敏锐而有策略，遇到复杂局面时会先观察再行动。你很擅长多线思考和灵活调整，关键时刻总能找到更聪明的处理路径。',
      emoji: '🐙',
      shareTitle: '我是冷静多线思考的章鱼型',
    },
    C: {
      title: '海龟型',
      desc: '你像海龟一样稳健耐久，不靠一时冲劲，而靠持续节奏推进目标。别人眼里你可能不张扬，但你在长期任务和压力场景里往往最可靠。',
      emoji: '🐢',
      shareTitle: '我是稳节奏高耐力的海龟型',
    },
    D: {
      title: '水母型',
      desc: '你像水母一样感知细腻、共情力强，能快速捕捉氛围变化和他人情绪。你在关系里更注重感受与边界平衡，适合做情绪调频和陪伴支持。',
      emoji: '🪼',
      shareTitle: '我是高感知共情的水母型',
    },
  },
  tendency: {
    A: {
...
export const TOPIC_QUESTIONS: TopicQuestion[] = [
  ...
  },
  {
    id: 'ocean_001',
    type: 'ocean',
    question: '进入一个全新的小组任务时，你第一反应通常是？',
    options: [
      { label: 'A', text: '先和大家聊开，快速拉齐氛围与分工' },
      { label: 'B', text: '先观察信息流，找最关键的切入点' },
      { label: 'C', text: '先定稳节奏，确保计划能持续推进' },
      { label: 'D', text: '先感受团队状态，再决定怎么配合' },
    ],
  },
  {
    id: 'ocean_002',
    type: 'ocean',
    question: '当计划突然变化时，你更像哪种处理方式？',
    options: [
      { label: 'A', text: '立刻组织沟通，边协作边修正' },
      { label: 'B', text: '迅速重排优先级，制定替代方案' },
      { label: 'C', text: '稳住核心目标，不被短期波动带偏' },
      { label: 'D', text: '优先安抚情绪，再推动下一步行动' },
    ],
  },
  {
    id: 'ocean_003',
    type: 'ocean',
    question: '朋友向你求助时，你最常见的支持模式是？',
    options: [
      { label: 'A', text: '陪他一起想办法，边聊边找突破口' },
      { label: 'B', text: '先拆解问题结构，给出清晰路径' },
      { label: 'C', text: '帮他建立可执行的长期节奏' },
      { label: 'D', text: '先接住情绪，让对方恢复状态' },
    ],
  },
  {
    id: 'ocean_004',
    type: 'ocean',
    question: '在班级或社团里，别人更可能这样评价你：',
    options: [
      { label: 'A', text: '很会连接不同人，是天然协作枢纽' },
      { label: 'B', text: '想法灵活，复杂问题里很有办法' },
      { label: 'C', text: '稳定靠谱，关键时刻能扛住压力' },
      { label: 'D', text: '感受细腻，能照顾到别人没说出口的状态' },
    ],
  },
  {
    id: 'tendency_001',
